...
namespace Tool.Compet.Log {
	public class DkLogs {
		...
		private static string MakeMessage(object where, string type, string message, object obj) {
			...
			if (obj != null) {
				message += ", dump_obj: " + DkJsons.Obj2Json(obj, Newtonsoft.Json.Formatting.Indented);
			}
